    ...
    public function run(): void
    {
        ...
        $pertanyaans = [
            ...
            [
                ...
                'list_jawaban' => json_encode([]),
                'need_description_on' => '',
                'desciption_hint' => 'Jelaskan secara rinci informasi atau kabar yang Anda dengar.',
                'pertanyaan' => 'Informasi apa yang Anda dengar?',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'list_jawaban' => json_encode([]),
                'need_description_on' => '',
                'desciption_hint' => 'Sebutkan nama, jabatan, atau hubungan pihak yang menyampaikan informasi kepada Anda.',
                'pertanyaan' => 'Dari siapa Anda mendengarnya?',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'list_jawaban' => json_encode([]),
                'need_description_on' => '',
                'desciption_hint' => 'Input tanggal, bulan, tahun, atau perkiraan waktu saat informasi disampaikan',
                'pertanyaan' => 'Kapan informasi disampaikan?',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'need_description_on' => 'Pernah memverifikasi sendiri',
                'desciption_hint' => 'Jelaskan singkat bagaimana cara Anda memverifikasinya:',
                'pertanyaan' => 'Apakah Anda pernah melihat atau memverifikasi sendiri?',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'need_description_on' => 'Ada',
                'desciption_hint' => 'Sebutkan siapa saja pihak lain yang dapat mengonfirmasi:',
                'pertanyaan' => 'Apakah terdapat pihak lain yang dapat mengonfirmasi?',
                'created_at' => now(),
                'updated_at' => now(),
            ],
        ];
